...
1. Download the Environment_Setup.sh file from the repository and place it into $PROJECT_DIR/
2. Open the Environment_Setup.sh file and update the SAMPLE_NAME variable with your sample name. Make sure to save the file before closing it.
